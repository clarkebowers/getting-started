...
#define DEVICE_INFO_MANUFACTURER_PROPERTY_VALUE           "IoT Guilford"
#define DEVICE_INFO_MODEL_PROPERTY_VALUE                  "MIMXRT1060-EVK-Wave"
#define DEVICE_INFO_SW_VERSION_PROPERTY_VALUE             "1.1.2"
